...
int main() {
  ...
  size = encode_character('k', braille);
  cout << "The character 'k' encoded in braille is '" << braille << "' (" << size << " characters)" << endl;
  ...
  cout << "The string 'S-Club7?' encoded in braille is:" << endl << braille << endl << endl;

  encode("Imperial College.", braille);
  cout << "The string 'Imperial College.' encoded in braille is:" << endl << braille << endl;
